---
title: "How to read covrpage report"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to read covrpage report}
...
# Case 1: package with a passing Travis build
...
# Case 2: package with a failing Travis build
...
* find where the failed tests are located in (table 2), if failing tests are the reason for the build failure.
